...
Ход работы:
1.Немного изменили шаблон кода из задания для более наглядной демонстрации работы экономики нашей игры (сделали упор на выведение сообщений, а не аудиофайлов).
```py
